...
func log_call_report(call_title: String, call_location: String, call_priority: String, call_response: String, call_status: String, call_notes: String) -> void:
	var report_number: String = "RPT-" + str(next_report_number)
	...
	print("Report logged: " + report_number + " | " + call_title)
